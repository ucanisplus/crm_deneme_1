  ...
  const performCalculation = async (panelsToCalculate, staticVars) => {
    ...
    for (const panel of panelsToCalculate) {
      try {
        ...
        const geciciHesap = {
          panel_kapasite: Number(panelKapasite),
          yalniz_panel_aylik: Number(yalnizPanelAylikKapasite),
          panel_kaynak_elektrik: Number(panelKaynakElektrikM2),
          panel_kesme_elektrik: Number(panelKesmeElektrikM2),
          diger_m2: Number(digerM2),
          yalniz_panel_isci_m2: Number(yalnizPanelIsciM2),
          galvaniz_tel_kg: Number(galvanizTelKg),
          boya_kapasite: Number(boyaKapasite),
          boya_aylik_kapasite: Number(boyaAylikKapasite),
          panel_boya_elektrik: Number(panelBoyaElektrikM2),
          panel_dogalgaz_m2: Number(panelDogalgazM2),
          panel_boya_isci_m2: Number(panelBoyaIsciM2),
          dp_boya_m2: Number(dpBoyaM2),
          sp_boya_m2: Number(spBoyaM2),
          profil_kapasite_ad: Number(profilKapasiteAd),
          profil_aylik_kapasite: Number(profilAylikKapasite),
          profil_boya_tuketim: Number(profilBoyaTuketimAdUSD),
          profil_elektrik_kesme_ad: Number(profilElektrikKesmeAd),
          profil_elektrik_kaynak_ad: Number(profilElektrikKaynakAd),
          profil_isci_uretim_ad: Number(profilIsciUretimAd),
          profil_hammadde_toplam: Number(profilHammaddeToplamAd),
          galvanizsiz_profil_fiyat_kg: Number(galvanizsizProfilFiyatKg),
          galvanizli_profil_fiyat_kg: Number(galvanizliProfilFiyatKg),
          profil_dogalgaz_tuketim: Number(profilDogalgazTuketimOran),
          profil_boya_elk_tuketim: Number(profilBoyaElektrikTuketimOran),
          adet_usd: Number(adetUSD),
          boyam2: Number(boyam2),
          boya_adet_usd: Number(boyaAdetUSD),
          boyali_adet_usd: Number(boyaliAdetUSD),
          manual_order: Number(manualOrder),
          panel_kodu: String(panelKodu),
          profil_yukseklik: Number(materialHeight),
          profil_agirlik: Number(profilAgirlik),
          flans_adet: Number(flansAdet),
          vida_adet: Number(vidaAdet),
          klips_adet: Number(klipsAdet),
          dubel_adet: Number(dubelAdet),
          kapak_adet: Number(kapakAdet),
          profil_saatlik_uretim: Number(profilSaatlikUretimKapasitesi),
          panel_adet_m2: Number(l1Metre),
          panel_adet_agirlik: Number(weightKg),
        };
